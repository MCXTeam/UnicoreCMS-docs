...
Файлы лежат в папке `storage`, сервер раздаёт их статикой. Загружает их игрок сам из кабинета, если у него есть право `player.skin.upload`. HD-версии открывает отдельное право, его обычно продают.
